<%-- 
    Document   : Vreq
    Created on : 31 Aug, 2020, 10:21:50 PM
    Author     : ADMIN
--%>
...
<head>
	...
	<title>Key-Policy Attribute-Based Encryption With Keyword Search in Virtulaized Environments</title>
<!--
		...
		<div class="inner" style="margin-top:-40px;">
			...
			<div class="col-xl-9 col-lg-8 col-md-12 col-sm-12 tm-content" style="background-color: bisque; color:black;">
					...
					<!-- section 1 -->
						...
						<div class="ml-auto">
							<header class="mb-4"><h1 class="tm-text-shadow" style="font-family: cursive; margin-top: -200px;">Owner-enabled Secure Authorized Keyword Search Over Encrypted Data With Flexible Metadata</h1></header>
						        <br><center><h2 style="font-family: cursive;">View all Key Send Details</h2></center><br>
                ...
                <table>
                    <tr>
                        ...
                        <td style='color:navy; font-weight: bold;'>OID</td>
