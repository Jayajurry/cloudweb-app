...
<body>
	...
	<!-- Page Content -->
      ...
      tr,td{
        ...
        <h2 style="margin-top: 20px; color:maroon; margin-left: 150px;font-family: cambria;font-weight: bold; font-size: 30px;">Data User Registration Page</h2><br>
        <form action="Usereg_Login_Action" method='post' enctype="multipart/form-data">
        <table>
         ...
         <h1 style="font-family: cursive; font-size: 13px; color: red;margin-left: 400px; "><a href="User_Login.jsp" style="font-family: cursive;  color: blue;font-size: 28x;">Click here to back</a></h1>
      </div>
					</section>										
				</div>	
			</div>	<!-- row -->			
