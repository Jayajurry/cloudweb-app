...
<body>
	...
	<div class="container-fluid tm-main">
		...
		<div class="inner" style="margin-top:-240px;">
         ...
         <li><a href="grap.jsp"><span class="fa fa-bars  mr-3"></span> Graph</a>
	        ...
	        <li> <a href="index.html"><span class="fa fa-paper-plane mr-3"></span> Logout</a>
                  </li>
                    </u1>
			...
			<div class="col-xl-9 col-lg-8 col-md-12 col-sm-12 tm-content" style="background-color: bisque; color:black;">
                ...
                <h3 style="color:brown;">View All Upload File</h3><br><br>                
                <table>
                    <tr>
    ...
    Document   : UploadFile
    Created on : 31 Aug, 2020, 8:02:26 PM
    Author     : ADMIN
--%>
