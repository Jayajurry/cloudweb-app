...
<body>
    ...
    <h2 align="center" style=" color:brown; font-family:Cambria;font-weight: bold; font-size: 30px; ">View all Search File Request Status</h2><br>
   <div class="container">
       				              <table>
                    <tr>
                        ...
                        <td style='color:navy; font-weight: bold;'>Confirmer Status</td>
                         <td style='color:navy; font-weight: bold;'>Server Status</td>
                         <td style='color:navy; font-weight: bold;'>Search</td>
                    </tr>
  ...
  <%          
                     String id=session.getAttribute("id").toString(); 
                        ...
                        PreparedStatement query=con.prepareStatement("select * from userreq where status=Accept and status1=Accept");
                        ...
                        while(rs.next()){
                         %> 
                            ...
                            <td > <a href="searchfile.jsp?id=<%=rs.getString("id")%>" style="color:green; ">Click me</a></td></tr>
                            <%}%></table> </form>  
                    <br></div></div></div>  
