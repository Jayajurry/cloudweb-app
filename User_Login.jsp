...
<body>
	...
	<div class="container-fluid tm-main">
      ...
      tr,td{
       ...
       <h2 style="margin-top: 20px; color:maroon; margin-left: 250px;font-family: cambria;font-weight: bold; font-size: 30px;">Data User Login</h2><br>
        ...
        <table>
         ...
         <h1 style="font-family: cursive; font-size: 23px; color: red;margin-left: 200px; ">New Registration?<a href="Register1.jsp" style="font-family: cursive; font-size: 28x; color:blue;">Click here</a></h1>
        </div>
					</section>										
				</div>	
			</div>	<!-- row -->			
