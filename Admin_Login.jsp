...
<body>
	...
	<div class="container-fluid tm-main">
      ...
      tr,td{
       ...
       <h2 style="margin-top: 20px; color:maroon; margin-left: 250px;font-family: cambria;font-weight: bold; font-size: 30px;">Data Owner Login</h2><br>
       <form action="owner">        <table>
         ...
         <h1 style="font-family: cursive; font-size: 23px; color: red;margin-left: 200px; ">New Registration?<a href="Register.jsp" style="font-family: cursive; font-size: 28x; color: blue;">Click here</a></h1>
        </div>
					</section>										
				</div>	
			</div>	<!-- row -->			
