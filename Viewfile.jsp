	...
	<div class="container-fluid tm-main">
		...
		<div class="inner" style="margin-top:-240px;">
	            ...
	            <a href="Owner_Home.jsp"><span class="fa fa-home mr-3"></span> Home</a>
                  ...
                  <li><a href="Upload.jsp"><span class="fa fa-user mr-3"></span> Upload File</a>
	          </li>
	          <li>
			...
			<div class="col-xl-9 col-lg-8 col-md-12 col-sm-12 tm-content" style="background-color: bisque; color:black;">
					...
					<!-- section 1 -->
						...
						<div class="ml-auto">
							<header class="mb-4"><h3 class="tm-text-shadow" style="font-family: cursive;"></h3></header>
							<style>
                    table{
                        line-height: 25px;
                        width: 80%;
                ...
                <table>
                    <tr>
                        ...
                        <td style='color:navy; font-weight: bold;'>Upload File</td>
                    </tr>
            ...
            String book=sb.toString();
                        ...
                        <td style='font-weight: bold; overflow: scroll; width: 200px; height: 200px;'><textarea rows="15" cols="40" style="width:200px;height: 200px;"><%=book%></textarea><br><br>
                        </td>
                       </tr><%}%>
                </table>
               </center><!-- data-nav-link holds the ID of nav item, which means this link should behave the same as that nav item  -->
						</div>
					</section>										
				</div>	
			</div>	<!-- row -->			
