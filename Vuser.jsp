			...
			<div class="col-xl-9 col-lg-8 col-md-12 col-sm-12 tm-content" style="background-color: bisque; color:black;">
					...
					<!-- section 1 -->
						...
						<div class="ml-auto">
							<header class="mb-4"><h1 class="tm-text-shadow" style="font-family: cursive;"></h1></header>
						        <br><center><h2 style="font-family: cursive; color:brown;">View all Users</h2></center><br>
                ...
                <table>
                    <tr>
                        ...
                        PreparedStatement query=con.prepareStatement("select * from reg where status='Unactivated' ");
