	...
	<div class="container-fluid tm-main">
		...
		<div class="inner" style="margin-top:80px;">
		 ...
		 <ul class="list-unstyled components mb-5" style="line-height: 1.5cm;">
	          ...
	          <li>
	              <a href="Search_Req.jsp"><span class="fa fa-user mr-3"></span> Search File & Make Request</a>
	          </li>
	          <li>
	        	          <li>
			...
			<div class="col-xl-9 col-lg-8 col-md-12 col-sm-12 tm-content" style="background-color: bisque; color:black;">
					...
					<!-- section 1 -->
						...
						<div class="ml-auto">
							<header class="mb-4"><h1 class="tm-text-shadow" style="font-family: cursive; color:darkturquoise;"></h1></header>
                ...
                <h3 style="color:brown;"><b>View Search Files & Make Request</b></h3>
                <br>
               <table>
       <tr>
           <td>ID</td>
           ...
           <td>Action</td>
                        ...
                        PreparedStatement query=con.prepareStatement("select * from upload where fname='"+fname+"'");
           ...
           <td style=" color: #00cae3;"><%=rs.getString("reg")%></td>
            <td style=" color: #00cae3;"><%=rs.getString("name")%></td>
             <td style=" color: #00cae3;"><%=rs.getString("fname")%></td>
              <td style=" color: #00cae3;"><%=rs.getString("dates")%></td>
           <td style='font-weight: bold;'><a href='View.jsp?name=<%=name%>&&id=<%=id%>&&reg=<%=rs.getString("reg")%>&&name=<%=rs.getString("name")%>&&image=<%=rs.getString("image")%>&&trap=<%=rs.getString("trapdoor")%>' style='color:Red;'>View</a></td>
                 
             
            <td style='font-weight: bold;'><a href='Request_File.jsp?name=<%=name%>&&id=<%=id%>&&reg=<%=rs.getString("reg")%>&&name=<%=rs.getString("name")%>&&image=<%=rs.getString("image")%>&&trap=<%=rs.getString("trapdoor")%>&&fname=<%=rs.getString("fname")%>' style='color:Red;'>Request Send</a></td>
