...
<%
    ...
    PreparedStatement pssw=con.prepareStatement("select * from upload");
     ...
     for ( String ss : arr) 
    {
        lis1.add(ss);
    ss=ss.toLowerCase();
    String sql="select * from upload where content  like '%"+ss+"%' ";
    ...
    String sql="select fname from upload";
    PreparedStatement pss=con.prepareStatement(sql);
...
<head>
	<meta charset="UTF-8">
	<title>Achieve Efficient and Verifiable Conjunctive and Fuzzy Queries over Encrypted Data in Cloud</title>
...
<body>
	<div class="header header-home">
		<div>
                    <center>
                    <h1 style="color:white;">Achieve Efficient and Verifiable Conjunctive and Fuzzy Queries over Encrypted Data in Cloud</h1>
		    </center>                    
